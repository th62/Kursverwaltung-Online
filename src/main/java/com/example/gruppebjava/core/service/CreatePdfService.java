...
// PDF für die Liste aller Kurse
    public void createKursListePdf() throws IOException {
        ...
        if (seitenGesamt > 0) {
            ...
            kurseListePdf.add(new Paragraph(neueZeile + "Es sind keine Kurse in der Kursverwaltung angelegt!").setFontSize(fontBig));
        }
...
// PDF für die Anwesenheitsliste
    public void createAnwesenheitslistePdf(long kursId, String datum) throws IOException {
        ...
        // teilnehmenden Personen ermitteln
        ...
        if (seitenGesamt > 0) {
            ...
            anwesenheitslistePdf.add(new Paragraph(neueZeile + "Es gibt keine Teilnehmer für diesen Kurs!").setFontSize(fontBig));
        }
